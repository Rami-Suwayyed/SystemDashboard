...
use App\Helpers\ApiResponse\Json\Senders\SendDatadWithTotal;
...
abstract class JsonResponse{
    ...
    public static function dataWithTotal($data,$total,$current =0) : SendDatadWithTotal{
        return static::$sender = new SendDatadWithTotal($data ,$total,$current);
    }
